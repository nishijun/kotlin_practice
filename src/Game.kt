...
fun checkWinner(player: Boolean): Boolean {
    ...
    for (i in 0..2)
        if (
        // Horizontal win
            (board[i][0] == checkSymbol && board[i][1] == checkSymbol && board[i][2] == checkSymbol) ||
            // Vertical win
            (board[0][i] == checkSymbol && board[1][i] == checkSymbol && board[2][i] == checkSymbol) ||
            // Diagonal win
            (board[0][0] == checkSymbol && board[1][1] == checkSymbol && board[2][2] == checkSymbol) ||
